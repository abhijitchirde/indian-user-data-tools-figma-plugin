...
const dataSet = {
    ...
    "RurVillageSuffix": ["Gram", "Panchayat", "Village", "Gaav", "Bazaar", "Railway", "Pada", "", "", "", "", "", "", "", "", "", ""],
...
function generateRandomRurAddress() {
    ...
    return `${landmarkConj} ${landmark}, ${village1} ${villageSuffix}, Dist - ${city}, ${state}, Pincode - ${pinFirstDigit}${pinRemainingDigits}`;
}
...
function generateTable(incomingMsg) {
    ...
    for (let i = 1; i <= userCount; i++) {
        ...
        const ruralAddress = `${rurLandmarkConj} ${rurLandmark}, ${rurVillage1} ${rurVillageSuffix}, Dist - ${cityName}, ${stateName}, Pincode - ${pinCode}`;
        //Email
